jQuery(function($){
    ...
    //NEW: Other settings section
    isOn
        ? $('.th-s1-other').stop(true,true).slideDown(150)
        : $('.th-s1-other').stop(true,true).slideUp(150);
    ...
    $('#add_video').on('click', function(){
        ...
        `);
         toggleUploadButton($('#th_gallery_list'));
    });

    $(document).on('change', 'select[name="th_gallery_type[]"], select[name="th_source"]', function(){
    toggleUploadButton($(document));
});
