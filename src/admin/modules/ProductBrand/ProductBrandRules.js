  ...
  { id: 'design', label: 'Design', icon: 'DESIGN' },
    ...
    return (
        <div className="store-one-rules-container">
            <h3 className="store-one-section-title">{__('Product Brand', 'store-one')}</h3>
                                        ...
                                        {rule.brand_list?.map((item, i) => (
                                            <div key={item.id} className="store-one-rule-item inner">
                                                ...
                                                <div className="store-one-rule-header">
                                                    ...
                                                    <strong className="s1-rule-title">
                                                    {sprintf(__('Brand %d', 'store-one'), i + 1)}
                                                </strong>
            ...
            <div className="s1-image-card">
                ...
                <div className="s1-image-actions">
                    ...
                    <button
                        ...
                        onClick={() =>
                            updateBuyItemField(index, i, 'image_url', '')
                        }
                    >
                        <TrashIcon />
                    </button>
...
<UniversalRangeControl
                ...
                onChange={(v) => updateField(index, 'margin_top', v)}
                            ...
                            <UniversalRangeControl
                               ...
                               onChange={(v) => updateField(index, 'margin_bottom', v)}
                                min={1}
                                max={250}
                            />
